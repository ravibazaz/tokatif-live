    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
      <div class="student-left-sidebar studentleft-tobg">
        <div class="profile-box">
           ...
           <div class="col"><a href="{{route('teacher-profile-edit')}}">Edit Profile</a></div>
           </div>
         ...
         <div class="my-lessons my-teacher-00 s-profile mt-4">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                   <h4>{{$studentData->name}} <span></h4>
                   <h5>{{$studentData->country_living_in}}</h5>
     ...
     <div class="col-lg-8 col-md-6 col-sm-12 col-12">
        ...
        <div class="my-lessons lesson-feedback mt-4">
            <div class="row"><div class="col"><h2>Lesson Feedback</h2></div></div>
             ...
             <div class="row">
               <div class="col-lg-4 col-md-4 col-sm-4 col-12 text-left">{{$completedLessonCount}}</div>
        ...
        <div class="my-lessons lesson-feedback mt-4">
            <div class="row"><div class="col"><h2>Community Activity</h2></div></div>
             ...
             <div class="row">
               <div class="col-lg-4 col-md-4 col-sm-4 col-12 text-left">{{$postedArticleCount}}</div>
               <div class="col-lg-4 col-md-4 col-sm-4 col-12 text-center">{{$postedForumCount}}</div>
               <div class="col-lg-4 col-md-4 col-sm-4 col-12 text-right">100</div>
             </div>
