              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active edit-p-tab1" id="home" role="tabpanel" aria-labelledby="home-tab">
                   ...
                   <div class="information-section">
                     ...
                     <form role="form" action="{{ route('teacher-settings-update') }}" method="POST" enctype="multipart/form-data" > 
                        {{ csrf_field() }}
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="information-section resume-certificate">
                     ...
                     <form role="form" action="{{ route('teacher-password-update') }}" method="POST" enctype="multipart/form-data" > 
                        {{ csrf_field() }}
                        <input type="hidden" class="form-control" name="id" value="{{$getLoggedIndata->id}}" />
                        <input type="hidden" class="form-control" name="role" value="{{$getLoggedIndata->role}}" />
                    ...
                    <div class="information-section">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                @foreach($saved_card_details as $val)
                                <div class="payment-card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-right"> 
                                            ...
                                            <small> {{$val->expiry_month}}/{{$val->expiry_year}} </small>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
