                                            ...
                                            <div class="tab-pane <?php if (isset($_GET['year']) && isset($_GET['week'])) {echo '';}else{echo 'active';}?>" role="tabpanel" id="lesson-step1">
                                                <div class="row mt-5"> 
                                                    ...
                                                    <div class="col-lg-9 col-12">
                                                      ...
                                                      @if($packageData)
                                                      <div class="lesson-box-select " data-lessonId="{{$v->id}}" style="cursor: pointer;">
                                                       <div class="row align-items-center"> 
                                                        <div class="col-lg-6 col-12">{{$v->name}}</div>
                                                        <div class="col-lg-3 col-12">5 Lessons taught</div>
                                                        <div class="col-lg-3 col-12"> 
                                                         <div class="form-check">
                                                          USD {{number_format($packageData,2)}} 
                                            ...
                                            <div class="tab-pane" role="tabpanel" id="lesson-step2">
                                               ...
                                               <div class="row mt-5">
                                                ...
                                                <div class="col-lg-3 col-12">
                                                    ...
                                                    <h5>Lesson Type</h5>
                                                    <p>{{ session('b_lesson_name') ? session('b_lesson_name') : '' }}</p>
                                                    </div>
                                                    ...
                                                    <div class="lesson-type-text">
                                                     <div class="row align-items-center">
                                                      <div class="col-lg-7">
                                                       ...
                                                       <p>{{ session('b_lesson_package') ? session('b_lesson_package') : '' }} &nbsp;&nbsp;&nbsp;
                                                       {{ session('b_lesson_package_time') ? session('b_lesson_package_time') : '' }}
                                                       </p>
                                                      </div>
                                                      <div class="col-lg-5"> <h3>USD {{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }}</h3></div>
                                                    </div>
                                                    </div>
                                              ...
                                              <div class="row mt-5">
                                                ...
                                                <table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-color:#eaeaea;" class="booking-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <td class="{{$class_0}} tbl-td" data-date="{{$dateArray[0]}}" data-time="{{date('H:i',$i)}}">&nbsp;  </td> 
                                                        ...
                                                        <td class="{{$class_1}} tbl-td" data-date="{{$dateArray[1]}}" data-time="{{date('H:i',$i)}}">&nbsp;  </td>
                                                        ...
                                                        ?>
                                                        <td class="{{$class_2}} tbl-td" data-date="{{$dateArray[2]}}" data-time="{{date('H:i',$i)}}">&nbsp;</td>
                                                        ...
                                                        ?>
                                                        <td class="{{$class_3}} tbl-td" data-date="{{$dateArray[3]}}" data-time="{{date('H:i',$i)}}">&nbsp;  </td>
                                                        ...
                                                        ?>
                                                        <td class="{{$class_4}} tbl-td" data-date="{{$dateArray[4]}}" data-time="{{date('H:i',$i)}}">&nbsp;  </td>
                                                        ...
                                                        ?>
                                                        <td class="{{$class_5}} tbl-td" data-date="{{$dateArray[5]}}" data-time="{{date('H:i',$i)}}">&nbsp;  </td>
                                                        ...
                                                        ?>
                                                        <td class="{{$class_6}} tbl-td" data-date="{{$dateArray[6]}}" data-time="{{date('H:i',$i)}}">&nbsp;  </td>
                                                    </tr>
                                                    @endfor
                                                ...
                                                <div class="row mt-5">
                                                    ...
                                                    <div class="lesson-type-text">
                                                     <div class="row">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <p>{{ session('b_communication_tool') ? session('b_communication_tool') : 'N/A' }}  : 
                                                      ...
                                                      <div class="col-lg-6">
                                                       <h5>Sub Total</h5>
                                                        ...
                                                        <div class="col-lg-6 text-right">
                                                          <h3>USD {{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }} </h3>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class="lesson-type-text">
                                                    ...
                                                    <div class="lesson-type-text">
                                                     <div class="row">
                                                      ...
                                                      <div class="col-lg-6 text-right"><h3>USD {{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }}</h3></div>
                                                    </div>
                                                    </div>
                                                    ...
                                                    <div class="lesson-type-text">
                                                     <div class="row">
                                                        <div class="col-lg-12"> <!--<a href="{{route('stripe')}}">Pay</a> -->
                                                            <a class="button-pay payment-data-modal" href="javascript:void(0);">Pay USD {{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }}</a>
                                                        </div>
                                                    </div>
                                                    </div>
       ...
       <div class="form-row"> 
        <div class="form-group col-lg-6 col-12">
            <p> Tokatif Pvt Ltd.<br/>
                Lesson Type: {{ session('b_lesson_name') ? session('b_lesson_name') : '' }} <br/>
                Lesson Package: {{ session('b_lesson_package') ? session('b_lesson_package') : '' }} &nbsp;&nbsp;&nbsp;
                                {{ session('b_lesson_package_time') ? session('b_lesson_package_time') : '' }}<br/>
                                
                Communication Tool: {{ session('b_communication_tool') ? session('b_communication_tool') : 'N/A' }}  : 
                                    {{ session('b_communication_tool_account_id') ? session('b_communication_tool_account_id') : 'N/A' }}<br/>
        ...
        <div class="form-group col-lg-6 col-12 pull-right">
            <p>Date: {{date('M d, Y')}} <br/>
                ...
                Total: {{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }} <br/>
            </p>
        </div>
       </div>    
       <!--<div class="form-row"> 
       ...
       <div class="form-row">       
        <div class="form-group col-md-12">
         <table width="100%" border="0" cellspacing="0" cellpadding="0" class="wallet-invoice-table">
              ...
              <tr>
                <td>Sub Total</td>
                <td align="right">${{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }} USD</td>
              </tr>
              <!--<tr>
              ...
              <tr>
                ...
                <td align="right"><strong>${{ session('b_booking_amt') ? number_format(session('b_booking_amt'),2) : '0.00' }} USD</strong></td>
              </tr>
            </table>
