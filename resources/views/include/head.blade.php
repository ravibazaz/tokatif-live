...
<title>{{$websitedata[0]->website}}</title>
...
<link rel="icon" type="image/png" href="{{ asset('storage/app/fabicon.ico') }}"  />
...
<!-- Bootstrap -->
<!--<link href="{{asset('public/frontendassets/css/flags.css?ddasda=42342423')}}" rel="stylesheet">-->
...
<link href="{{asset('public/frontendassets/css/font-awesome.min.css')}}" rel="stylesheet">
<link rel="stylesheet" href="{{asset('public/frontendassets/css/css_animate.css')}}">
