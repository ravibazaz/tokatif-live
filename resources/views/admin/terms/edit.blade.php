            ...
            <div class="card-body">
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" name="title" value="{{$terms->title}}" class="form-control" placeholder="">
                  @if ($errors->has('title'))
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea name="description" id="description" class="form-control" rows="8" placeholder="">{{$terms->description}}</textarea>
