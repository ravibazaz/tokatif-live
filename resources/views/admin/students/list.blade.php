            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$a->address}}</td>
                  <td>
                  <a href="{{route('admin-student-details',['id'=>$a->id]) }}" class="actionLink" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
                  <a href="{{ route('admin-student-delete',['id'=>$a->id]) }}" onclick="return confirm('Are you sure?')" class="actionLink"><i class="fa fa-trash"></i></a> 
                  </td>
                </tr>
                @endforeach
