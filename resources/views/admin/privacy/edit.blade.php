        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ url('admin/privacy/'.$privacy->id) }}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}

              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="inputEmail4">Title</label>
                  <input type="text" name="title" value="{{$privacy->title}}" class="form-control" placeholder="">
                  @if ($errors->has('title'))
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea name="description" id="description" class="form-control" rows="6" placeholder="">{{$privacy->description}}</textarea>
