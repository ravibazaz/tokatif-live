    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview <?php echo e((request()->is('admin/privacy') || request()->is('admin/privacy/*') ) ? 'menu-open' : ''); ?>"> 
            <a href="<?php echo e(route('admin-privacy-list')); ?>" class="nav-link <?php echo e((request()->is('admin/privacy') || request()->is('admin/privacy/*') ) ? 'active' : ''); ?>">
              <i class="nav-icon fa fa-tasks"></i>
              <p> Privacy </p>
            </a>
          </li>  
          
          <li class="nav-item has-treeview <?php echo e((request()->is('admin/terms') || request()->is('admin/terms/*') ) ? 'menu-open' : ''); ?>"> 
            <a href="<?php echo e(route('admin-terms-list')); ?>" class="nav-link <?php echo e((request()->is('admin/terms') || request()->is('admin/terms/*') ) ? 'active' : ''); ?>">
              <i class="nav-icon fa fa-tasks"></i>
              <p> Terms </p>
            </a>
          </li>
...
<?php /**PATH /home/tokatifc/public_html/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>