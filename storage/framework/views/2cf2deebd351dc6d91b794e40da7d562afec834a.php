...
<div class="sidebar">
  <ul>
    ...
    <li class="<?php echo e(Request::segment(1)=='my-lesson' ? 'active' : ''); ?>"> 
        <a href="<?php echo e(route('my-lesson')); ?>">
    ...
    <!-- <li class="<?php echo e(Request::segment(1)=='lesson-package' ? 'active' : ''); ?>"> 
        <a href="<?php echo e(route('lesson-package')); ?>">
        <img src="https://staging.tokatif.com/public/frontendassets/images/lesson_icon.png" class="img-fluid normal"/>
    ...
    <li class="<?php echo e(Request::segment(1)=='my-students' ? 'active' : ''); ?>">
        <a href="<?php echo e(route('my-students')); ?>"> 
    ...
    <li class="<?php echo e(Request::segment(1)=='my-wallet' ? 'active' : ''); ?>">
    ...
    <li class="<?php echo e(Request::segment(1)=='lesson-management' ? 'active' : ''); ?>">
        <a href="<?php echo e(route('lesson-management')); ?>">
    ...
    <li>
        ...
        <ul class="sub-menu collapse tedit-icon" id="dashboard" style="">
            <li class="<?php echo e(Request::segment(1)=='teacher-profile-edit' ? 'active' : ''); ?>"><a href="<?php echo e(route('teacher-profile-edit')); ?>">
            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span>Edit Teacher Profile</span></a></li> 
            <li class="<?php echo e(Request::segment(1)=='teacher-calendar' ? 'active' : ''); ?>"><a href="<?php echo e(route('teacher-calendar')); ?>"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span>Edit Availability</span> </a></li>
            
            <!--
            <li class="active"><a href="<?php echo e(route('teacher-profile')); ?>">Edit Teacher Profile</a></li>
            <li><a href="#">Withdraw</a></li>-->
        </ul>
    </li>
    <li class="<?php echo e(Request::segment(1)=='teacher-settings' ? 'active' : ''); ?>"> 
    ...
    <li class="<?php echo e(Request::segment(1)=='community' ? 'active' : ''); ?>"> 
    ...
    <!--<li>
        ...
        <ul class="sub-menu collapse" id="lesson" style="">
            <li><a href="<?php echo e(route('lesson-management')); ?>"> Lesson Management </a></li>
            <li><a href="<?php echo e(route('lesson-package')); ?>"> My Packages </a></li>
            <li>
            <a href="<?php echo e(route('my-lesson')); ?>"> 
            <img src="https://staging.tokatif.com/public/frontendassets/images/lesson_icon.png" class="img-fluid normal"/>
            <img src="https://staging.tokatif.com/public/frontendassets/images/lesson_iconhover.png" class="hover-on"/>
            My Lessons </a></li> 
            <li><a href="<?php echo e(route('add-lesson')); ?>"> Create New Lesson </a></li> 
        </ul>
    ...
    <!--<li><a href="<?php echo e(route('community')); ?>"><i class="fa fa-table"></i><span>Teacher Forum</span></a></li>-->
    
    </ul>
</div><?php /**PATH /home/tokatifc/public_html/resources/views/include/teacher-left-sidebar.blade.php ENDPATH**/ ?>