    ...
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-12 col-12">
       <div class="small-left-calender">
           ...
           <?php echo $__env->make('include/student-current-month-calendar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
       ...
       <div class="sort-by">
          <h4> </h4>
          <ul>
           <li><a href="javascript:void(0);"><img src="<?php echo e(asset('public/frontendassets/images/shot-1.png')); ?>"> Previous </a></li>
           <li><a href="javascript:void(0);"><img src="<?php echo e(asset('public/frontendassets/images/shot-2.png')); ?>"> Upcoming <!--<span class="white-round">1</span>--> <span><i class="fa fa-check" aria-hidden="true"></i></span></a></li>
           <!--<li><a href="javascript:void(0);"><img src="<?php echo e(asset('public/frontendassets/images/shot-3.png')); ?>"> Waiting <span><i class="fa fa-check" aria-hidden="true"></i></span></a></li>-->
           <li><a href="javascript:void(0);"><img src="<?php echo e(asset('public/frontendassets/images/shot-4.png')); ?>"> Today Booked <span><i class="fa fa-check" aria-hidden="true"></i></span></a></li>
          </ul>
        </div>
...
<?php /**PATH /home/tokatifc/public_html/resources/views/student/calendar.blade.php ENDPATH**/ ?>