      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <div class="image">
                <img src=<?php echo e(asset("public/admin/img/logo.jpg")); ?> class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
   ...
   <?php /**PATH /home/tokatifc/staging.tokatif.com/resources/views/admin/includes/header.blade.php ENDPATH**/ ?>