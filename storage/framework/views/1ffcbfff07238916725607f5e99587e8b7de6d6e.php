<?php header("Access-Control-Allow-Origin: *"); ?>
    ...
    <title>Tokatif | Admin Panel</title>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href=<?php echo e(asset("public/assets/plugins/summernote/summernote-bs4.css")); ?>>
    <link rel="stylesheet" href=<?php echo e(asset("public/assets/plugins/ekko-lightbox/ekko-lightbox.css")); ?>>
    <!-- Google Font: Source Sans Pro -->
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
    <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href=<?php echo e(asset("public/admin/custom.css")); ?> rel="stylesheet" />
    ...
    <script src="//code.jquery.com/jquery-1.11.1.min.js"></script>--><?php /**PATH /home/tokatifc/public_html/resources/views/admin/includes/head.blade.php ENDPATH**/ ?>