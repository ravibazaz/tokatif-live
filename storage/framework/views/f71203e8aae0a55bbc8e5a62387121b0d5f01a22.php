        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo e(url('admin/terms/add')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tokatifc/public_html/resources/views/admin/terms/add.blade.php ENDPATH**/ ?>