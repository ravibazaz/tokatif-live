              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active edit-p-tab1" id="home" role="tabpanel" aria-labelledby="home-tab">
                   ...
                   <div class="information-section">
                     ...
                     <form role="form" action="<?php echo e(route('student-settings-update')); ?>" method="POST" enctype="multipart/form-data" > 
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="information-section resume-certificate">
                     ...
                     <form role="form" action="<?php echo e(route('password-update')); ?>" method="POST" enctype="multipart/form-data" > 
                        <?php echo e(csrf_field()); ?>
                     ...
                     <div class="col-md-8">
                        <table id="myTable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tr>
                            ...
                            <td><?php echo e($val->amount); ?> USD</td>
                            <td><?php echo e($val->brand); ?></td>
                            <td><?php echo e($val->country); ?></td>
                            <td class="succes-td"><?php echo e($val->status); ?></td>
                          </tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/tokatifc/public_html/resources/views/student/setting.blade.php ENDPATH**/ ?>