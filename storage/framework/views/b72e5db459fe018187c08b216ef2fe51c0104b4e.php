                                    ...
                                    <div class="wizard-inner">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li role="presentation" class="disabled">
                                                ...
                                                <span class="round-tab"><img src="<?php echo e(asset('public/frontendassets/images/stepimg2.png')); ?>" class="img-fluid"/></span> <i>Choose Lesson Options</i></a>
                                            </li>
                                            <li role="presentation" class="<?php if (isset($_GET['year']) && isset($_GET['week'])) {echo 'active';}else{echo 'disabled';}?>">
                                                ...
                                                <span class="round-tab"><img src="<?php echo e(asset('public/frontendassets/images/stepimg3.png')); ?>" class="img-fluid"/></span> <i>Schedule Your Lessons</i></a>
                                            </li>
                                            <li role="presentation" class="disabled">
                                                <a href="#lesson-step4" data-toggle="tab" aria-controls="lesson-step4" role="tab">
                                                <span class="round-tab"><img src="<?php echo e(asset('public/frontendassets/images/stepimg4.png')); ?>" class="img-fluid"/></span> <i>Communication Tool</i></a>
                                            </li>
                                             <li role="presentation" class="disabled">
                                                <a href="#lesson-step5" data-toggle="tab" aria-controls="lesson-step5" role="tab">
                                                <span class="round-tab"><img src="<?php echo e(asset('public/frontendassets/images/stepimg5.png')); ?>" class="img-fluid"/></span> <i>Payment</i></a>
                                            </li>
                                        </ul>
                                    </div>
                    

                                    <!--<form action="<?php echo e(route('booking-data', ['id' => Request::segment(2)])); ?>"  method="GET" class="login-box"> -->
                                        
                                        <input type="hidden" name="teacher_id" value="<?php echo e(Request::segment(2)); ?>" />
                                                            ...
                                                            ?>
                                                                <div class="col-lg-4 col-md-3 col-sm-12 col-12">
                                                                 <div class="lesson-rightpic">
                                                                    <?php if($exists && $selected_teacher->profile_photo!=''): ?> 
                                                                        <img src="<?php echo e(url('storage/app/user_photo/'.$selected_teacher->profile_photo)); ?>" class="img-fluid">
                                                                    <?php else: ?>
                                                                        <img src=<?php echo e(Asset("public/assets/dist/img/transparent.png")); ?> class="img-fluid">   
                                                                    <?php endif; ?>
                                                                    
                                                                    <?php $flag = ''; ?>
                                                                    <?php if($selected_teacher->country_living_in!=''): ?>
                                                                        <?php
                                                                ...
                                                                <div class="col-lg-8 col-md-9 col-sm-12 col-12 pl-0">
                                                                   <h4><?php echo e($selected_teacher->name); ?></h4>
                                            ...
                                            <div class="tab-pane <?php if (isset($_GET['year']) && isset($_GET['week'])) {echo 'active';}else{echo '';}?>" role="tabpanel" id="lesson-step3">
                                              ...
                                              <div class="row mt-5">
                                                ...
                                                <table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-color:#eaeaea;" class="booking-table">
                                                    ...
                                                    <?php for($i=$start; $i<=$end; $i = $i + 30*60): ?>
                                                        <?php
                                                            $now = strtotime(date("Y-m-d H:i:s"));
                                                        ?>
                                                    <tr>
                                                        <td align="center"><?php echo e(date('H:i',$i)); ?></td>
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-lg-9 col-12">
                                                      ...
                                                      <div class="row">
                                                       ...
                                                       <div class="row align-items-center"> 
                                                        <div class="col-lg-9 col-12"><img src="<?php echo e(asset('public/frontendassets/images/credit-card.png')); ?>" class="img-fluid"/> Credit / Debit Card</div>
                                                        <div class="col-lg-3 col-12"> 
                                                         <div class="form-check">
                                                        ...
                                                        <div class="col-lg-6 col-12">
                                                          <div class="communication-row">
                                                       <div class="row align-items-center"> 
                                                        <div class="col-lg-9 col-12"><img src="<?php echo e(asset('public/frontendassets/images/paypal-lesson.png')); ?>" class="img-fluid"/> Paypal</div>
                                                        <div class="col-lg-3 col-12"> 
                                                         <div class="form-check">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer text-center">
        <form id="paymentForm" action="" method="POST" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(env('STRIPE_KEY')); ?>"> 
            <?php echo csrf_field(); ?>
            <input type="hidden" name="payment_teacher_id" id="payment_teacher_id" value="<?php echo e(Request::segment(2)); ?>" />
