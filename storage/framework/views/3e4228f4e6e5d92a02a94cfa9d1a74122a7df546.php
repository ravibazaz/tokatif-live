         ...
         <div class="my-lessons my-teacher-00 s-profile mt-4">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                   ...
                   <h4><?php echo e($teacherData->name); ?> <span></h4>
        ...
        <div class="my-lessons lesson-feedback mt-4">
            ...
            <div class="row"><div class="col"><h2>Lesson Feedback</h2></div></div>
             ...
             <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-4 col-4 text-left"><?php echo e($completedLessonCount); ?></div>
        ...
        <div class="my-lessons lesson-feedback mt-4">
            ...
            <div class="row"><div class="col"><h2>Community Activity</h2></div></div>
             ...
             <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-4 col-4 text-left"><?php echo e($postedArticleCount); ?></div>

               <div class="col-lg-4 col-md-4 col-sm-4 col-4 text-center"><?php echo e($postedForumCount); ?></div>
...
<?php /**PATH /home/tokatifc/public_html/resources/views/student/profile.blade.php ENDPATH**/ ?>