...
<section class="top_foot">
  ...
  <div class="container">
      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
       ...
       <div class="call-to-action">
          ...
          <div class="cta-bg bg-primary-color">
              ...
              <?php if(Session::get('success_n')): ?>

              <div class="alert alert-success alert-dismissible fade show">

                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>

                <strong>Success!</strong> <?php echo e(Session::get('success_n')); ?></div>

              <?php endif; ?>

              <?php if(Session::get('error_n')): ?>

              <div class="alert alert-danger alert-dismissible fade show">

                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>

                <strong>Note!</strong> <?php echo e(Session::get('error_n')); ?></div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 col-12">
                      ...
                      <div class="newsletter-form mrt-md-40">
                          ...
                          <form action="<?php echo e(route('newsletter-email')); ?>" method="POST"> 
                          ...
                          <?php echo e(csrf_field()); ?>
                              ...
                              <div class="form-group clearfix">
                                  ...
                                  <input type="email" name="newsletter_email" value="<?php echo e(Request::old('newsletter_email')); ?>" placeholder="Email address" required>

                                  <?php if($errors->has('newsletter_email')): ?>

                                    <span class="text-danger"><?php echo e($errors->first('newsletter_email')); ?></span>
    ...
    <div class="foor_wrap wow bounceInUp">
      ...
      <a href="<?php echo e(url('/')); ?>"><img src="https://staging.tokatif.com/public/frontendassets/images/footerlogo.png" class="img-fluid"/></a>

       <p><?php echo e($websitedata[0]->footer_content); ?></p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-4 col-12">
          ...
          <div class="phone_nav">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(route('teacher-search',['language'=>'English'])); ?>" > English</a></li>

                <li><a href="<?php echo e(route('teacher-search',['language'=>'Chinese'])); ?>" > Chinese (Mandarin)</a></li>

                <li><a href="<?php echo e(route('teacher-search',['language'=>'Korean'])); ?>" > Korean</a></li>

                <li><a href="<?php echo e(route('teacher-search',['language'=>'Japanese'])); ?>" > Japanese</a></li>      

                <li><a href="<?php echo e(route('teacher-search',['language'=>'French'])); ?>" > French</a></li>

                <li><a href="<?php echo e(route('teacher-search',['language'=>'Italian'])); ?>" > Italian</a></li>

                <li><a href="<?php echo e(route('teacher-search',['language'=>'German'])); ?>" > German</a></li>

                <li><a href="<?php echo e(route('teacher-search',['language'=>'Spanish'])); ?>" > Spanish</a></li>
...
<section class="cwrite_sec">
  ...
  <div class="container text-center">
    ...
    <p> <?php echo e($websitedata[0]->copyright_content); ?></a></p>
...
<script type="text/javascript" src="<?php echo e(asset('public/frontendassets/js/bootstrap.min.js')); ?>"></script> 
...
<script type="text/javascript" src="<?php echo e(asset('public/frontendassets/sticky/jquery.stickit.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/frontendassets/js/wow.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/frontendassets/js/custom.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/frontendassets/js/master.js')); ?>"></script>
...
function scrollToBottomFunc() { console.log("auto scroll.....");
    ...
    var my_id = "<?php echo e(session('id')); ?>";

    var urlSegment = "<?php echo e(Request::segment(1)); ?>";
...
$('.teacherSearchApplyBtn').on("click", function() {
    ...
    if(selectedFilter!=''){
        ...
        $.ajax({
            ...
            url:"<?php echo e(route('post-teacher-search')); ?>",
...
$(document).on('click','.payment-data-modal',function(e){ 
    ...
    if(userRole!='' && userRole=='1'){
        ...
        if(parseFloat(wallet_amt) >= parseFloat(booking_amount)){ 
            ...
            var post_url = "<?php echo e(route('booking-data')); ?>"; 

        }else{      

            var post_url = "<?php echo e(route('stripe-post')); ?>";   
...
<?php /**PATH /home/tokatifc/staging.tokatif.com/resources/views/include/footer.blade.php ENDPATH**/ ?>