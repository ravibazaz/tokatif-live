      ...
      <div class="filter-dropdown-checkboxes">
        ...
        <div class="filter-dropdow-items">
          ...
          <label class="filter-checkbox ant-checkbox-wrapper"><span class="ant-checkbox">
            <input type="checkbox" class="ant-checkbox-input searchCountryNameClass" data-cy="ts_from_AF" name="searchCountryName" value="<?php echo e($val->name); ?>">
            <span class="ant-checkbox-inner"></span></span><span><span><?php echo e($val->name); ?></span></span></label>
  ...
  <div class="card">
    ...
    <div>
      <div class="filter-from">
        ...
        <label class="filter-checkbox ant-checkbox-wrapper"><span class="ant-checkbox">
          <input type="checkbox" class="ant-checkbox-input searchLanguageNameClass" data-cy="ts_alsospeak_english" name="searchLanguageName" value="<?php echo e($val->name); ?>">
          <span class="ant-checkbox-inner"></span></span><span><span><?php echo e($val->name); ?></span></span></label>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
          ...
          <div class="filter-body">
            <div class="filter-checkbox-groups">
              <div class="filter-checkbox-group">
                ...
                <?php $__currentLoopData = $lessonType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="filter-checkbox ant-checkbox-wrapper"><span class="ant-checkbox">
                  <input type="checkbox" name="searchLessonType" class="ant-checkbox-input" data-cy="ts_category_1" value="<?php echo e($val->name); ?>">
                  <span class="ant-checkbox-inner"></span></span><span><span><?php echo e($val->name); ?></span></span></label>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="filter-container filter-container-speaks" style="width: 280px;">
          <div class="filter-body">
            <div class="filter-from">
                ...
                <?php $__currentLoopData = $lessonTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                <label class="filter-checkbox ant-checkbox-wrapper"><span class="ant-checkbox">
                    <input type="checkbox" name="searchfocusAreas" class="ant-checkbox-input" data-cy="" value="<?php echo e($val->tag); ?>">
                    <span class="ant-checkbox-inner"></span></span><span><span><?php echo e($val->tag); ?></span></span></label> 
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</section><?php /**PATH /home/tokatifc/public_html/resources/views/user/teacher-search-bar.blade.php ENDPATH**/ ?>