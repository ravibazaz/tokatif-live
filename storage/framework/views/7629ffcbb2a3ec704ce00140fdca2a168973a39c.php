        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo e(url('admin/privacy/add')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo e(csrf_field()); ?>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <textarea name="description" rows="6" class="form-control" placeholder=""></textarea>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tokatifc/public_html/resources/views/admin/privacy/add.blade.php ENDPATH**/ ?>