                ...
                <div class="btn-group float-right sort-dropdown" role="group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                       ...
                       <li><a href="#Unscheduled" data-toggle="tab"><img src="<?php echo e(asset('public/frontendassets/images/unscheduled.png')); ?>"/> Today <?php if(count($today_lesson)>0): ?> <span class="white-round"><?php echo e(@count($today_lesson)); ?></span> <?php endif; ?> </a></li>
                    ...
                    <div class="eline-accept-total">
                        ...
                        <div class="row align-items-center justify-content-md-center m-auto deline-accept">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-12 text-center">
                                ...
                                <a href="<?php echo e(route('teacher-decline-lesson',['id'=>$val->id])); ?>" onclick="return confirm('Do you want to decline the lesson request?')" >DECLINE</a>

                            </div>

                            <div class="col-lg-3 col-md-4 col-sm-4 col-12 text-center">

                                <a href="<?php echo e(route('teacher-accept-lesson',['id'=>$val->id])); ?>" onclick="return confirm('Do you want to accept the lesson request?')" >ACCEPT</a>
              ...
              <?php if(count($pending)>0): ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <ul class="box-text-grid">
                      ...
                      <li><h3> <?php echo e(date('d M Y',strtotime($val->booking_date))); ?> </h3></li>

                      <li> <?php echo e(date('h:i a',strtotime($val->booking_time))); ?> <span class=""><?php echo e(number_format($val->booking_amount,2)); ?> USD</span></li>

                      <li> <?php echo e($lessonData->language_taught); ?> Language</li>

                      <li> <?php echo e($lessonPackageData->time); ?> Duration</li>
        ...
        <div class="tab-pane" id="Unscheduled">
            ...
            <section class="lesson-gride">
                ...
                <div class="row">
                    ...
                    <?php if(count(@$today_lesson)>0): ?>

                        <?php $__currentLoopData = @$today_lesson; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-12 text-center">
                        ...
                        <?php if($val->lesson_started_at==''): ?>
                            ...
                            <a href="<?php echo e(route('teacher-enter-classroom',['id'=>$val->id])); ?>" class="button-room" onclick="return confirm('Do you want to enter the class room now?')" >Enter class room </a>
   ...
   <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        ...
        <div class="row active-inactive-package">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-12">         
           ...
           <h3><i class="fa fa-play-circle" aria-hidden="true"></i> Active Packages <?php echo e(count($active_packages)); ?></h3>
            ...
            <div class="row">
                ...
                <?php if(count($active_packages)>0): ?>
                    ...
                    <?php $__currentLoopData = $active_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                        ...
                        <div class="gride-box lesson-list-box">   
                         ...
                         <h4><span class="upcoming-text"><?php echo e($val->name); ?></span></h4>

                         <p>Language: <?php echo e($val->language_taught); ?></p>

                         <p>Duration: <?php echo e($val->time); ?></p>

                         <h4>Price: <?php echo e($val->total); ?> USD </h4>

    					 <p><?php echo e($val->package); ?></p>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-12 inactive-tab mt-5">  
            ...
            <h3><i class="fa fa-stop-circle" aria-hidden="true"></i> Inactive <?php echo e(count($inactive_packages)); ?></h3>

            

             <div class="row">

                <?php if(count($inactive_packages)>0): ?>

                    <?php $__currentLoopData = $inactive_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        ...
                        <section class="lessonnew-page">
                            <div class="container">
                                <form role="form" action="<?php echo e(route('send-lesson-invitation')); ?>" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="information-section">
                                        ...
                                        <div class="form-group col-lg-12 img-select">
                                            ...
                                            <select name="student_id" id="i_student_id" class="vodiapicker">
                                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                <option value="<?php echo e($val->id); ?>" class="test" data-thumbnail="<?php echo e($photo); ?>"><?php echo e($val->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="student_id" id="i_student_id" class="form-control custom-select invitationType">
                                                ...
                                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                <option value="<?php echo e($val->id); ?>" <?php echo e((Request::old('student_id') == $val->id) ? 'selected' : ''); ?> class="test" data-thumbnail="<?php echo e($photo); ?>"><?php echo e($val->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                            <div class="slot-box">
                                              <h4>Lesson</h4>
                                              <input class="form-check-input invitationType" type="radio" name="type" id="exampleRadios1" value="lesson" <?php echo e(Request::old('type') == "lesson" ? 'checked' : ''); ?> >
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                            <div class="slot-box">
                                              <h4>Package</h4>
                                              <input class="form-check-input invitationType" type="radio" name="type" id="exampleRadios2" value="package" <?php echo e(Request::old('type') == "package" ? 'checked' : ''); ?> >
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row LanguagesDivClass">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="language_taught" id="language_taught" class="form-control custom-select">
                                              ...
                                              <option value="<?php echo e($val->language_taught); ?>" <?php echo e((Request::old('language_taught') == $val->language_taught) ? 'selected' : ''); ?>><?php echo e($val->language_taught); ?></option>
                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="form-row LessonDivClass">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="lesson_id" id="i_lesson_id" class="form-control custom-select">
                                              <option value="">Please Select</option>
                                              <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value="<?php echo e($val->id); ?>" <?php echo e((Request::old('lesson_id') == $val->id) ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                            <div class="slot-box">
                                              <h4><span><img src="<?php echo e(Asset("public/frontendassets/images/skype.png")); ?>" class="img-fluid"></span> Skype</h4>
                                              <input class="form-check-input iCommunicationTool" type="radio" name="communication_tool" id="exampleRadios5" value="skype" <?php echo e(Request::old('communication_tool') == "skype" ? 'checked' : ''); ?> >
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 form-group">
                                            <div class="slot-box">
                                              <h4><span><img src="<?php echo e(Asset("public/frontendassets/images/zoom_1.png")); ?>" class="img-fluid"></span> Zoom</h4>
                                              <input class="form-check-input iCommunicationTool" type="radio" name="communication_tool" id="exampleRadios6" value="zoom" <?php echo e(Request::old('communication_tool') == "zoom" ? 'checked' : ''); ?> >
                                            </div>
                                        </div>
                                        <?php if($errors->has('communication_tool')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('communication_tool')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-lg-12 col-12 bookright-icon mt-3">
                                            <input type="text" class="form-control" name="communication_tool_id" id="communication_tool_id" value="<?php echo e(Request::old('communication_tool_id')); ?>" placeholder="Communication Tool ID" >
                                            <?php if($errors->has('communication_tool_id')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('communication_tool_id')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9 mb-5 mt-4">
                                            <div class="input-group">
                                              <input type="number" class="form-control" name="old_price" id="old_price" value="<?php echo e(Request::old('old_price')); ?>" placeholder="$" readonly>
                                    ...
                                    <div class="form-row OfferPriceDivClass">
                                        ...
                                        <div class="col-md-9 mb-5 mt-4">
                                            <div class="input-group">
                                              <input type="number" class="form-control" name="offer_price" id="offer_price" value="<?php echo e(Request::old('offer_price')); ?>" placeholder="$" aria-describedby="inputGroupPrepend">
                                              <div class="input-group-prepend"> <span class="input-group-text" id="inputGroupPrepend">USD</span> </div>
                                            </div>
                                            <?php if($errors->has('offer_price')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('offer_price')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-2">
                                                <div class="form-check">
                                                  <input class="form-check-input" type="radio" name="schedule_time" id="exampleRadiosSingle" value="Single" <?php echo e(Request::old('schedule_time') == "Single" ? 'checked' : ''); ?> >
                                                  <label class="form-check-label" for="exampleRadiosSingle"> Single </label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <div class="form-check">
                                                  <input class="form-check-input" type="radio" name="schedule_time" id="exampleRadiosWeekly" value="Weekly" <?php echo e(Request::old('schedule_time') == "Weekly" ? 'checked' : ''); ?> >
                                                  <label class="form-check-label" for="exampleRadiosWeekly"> Weekly </label>
                                                </div>
                                            </div>    
                                            <?php if($errors->has('schedule_time')): ?>
                                                <span class="text-danger"><?php echo e($errors->first('schedule_time')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="form-row mt-3"> 
                                            <div class="form-group col-md-6 calender-icon">
                                                <label for="inputEmail4">Choose a date</label>
                                                <input type="date" name="i_date" class="form-control" id="i_inputDate" value="<?php echo e(Request::old('i_date')); ?>" >
                                                <?php if($errors->has('i_date')): ?>
                                                    <span class="text-danger"><?php echo e($errors->first('i_date')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                                    ...
                                                    <div class="form-group col-md-5 pr-0">
                                                      <select name="from_time" id="from_time" class="form-control custom-select">
                                                        ...
                                                        <?php if($errors->has('from_time')): ?>
                                                            <span class="text-danger"><?php echo e($errors->first('from_time')); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="form-group col-md-5 p-0">
                                                      <select name="to_time" id="to_time" class="form-control custom-select">
                                                        ...
                                                        <?php if($errors->has('to_time')): ?>
                                                            <span class="text-danger"><?php echo e($errors->first('to_time')); ?></span>
                                                        <?php endif; ?>
                                                    </div>
...
<?php /**PATH /home/tokatifc/public_html/resources/views/teacher/my-lesson.blade.php ENDPATH**/ ?>